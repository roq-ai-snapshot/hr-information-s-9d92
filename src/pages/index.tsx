  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Your comprehensive solution for managing employee data, vacations, and payroll effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Your comprehensive solution for managing employee data, vacations, and payroll effortlessly.`}
            </Text>
            <Box
